...
本项目是一个面向前端开发者的**开源AI赋能解决方案**，致力于将人工智能深度融合前端工程全流程。它不仅是自研使用工具的集合，更是一个 Agent 能力 + Skill/Rule + 工作流与实践的AI能力沉淀平台，是构建智能时代前端生产力的基础设施。
...
- 项目地址：<https://gitcode.com/liuguolin/DevHelper.git>
- 问题反馈：<https://gitcode.com/liuguolin/DevHelper.git/issues>
